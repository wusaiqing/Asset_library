(function ($) {
    ...
    function bindData(template, data, settings) {
        ...
        processElements("data-tt-id", template, data, settings, function ($elem, value) {
        	$elem.attr("data-tt-id", applyFormatters($elem, value, "data-tt-id", settings));
        });
        processElements("data-tt-parent-id", template, data, settings, function ($elem, value) {
        	 $elem.attr("data-tt-parent-id", applyFormatters($elem, value, "data-tt-parent-id", settings));
        });
        
        //用于demo，自义定属性
        processElements("data-demo-a-id", template, data, settings, function ($elem, value) {
       	 $elem.attr("data-demo-a-id", applyFormatters($elem, value, "data-demo-a-id", settings));
       });
