...
define(function(require, exports, module) {
	...
	var searchCourseUnitsList = {
			...
			init : function() {
				...
				$("button[name='searchInp']").on('click', function() {
					// 保存查询条件
					searchCourseUnitsList.pagination.setParam(searchCourseUnitsList.getQueryParams());
				});
				/*
				 * 导出
				 * 导出名称如：实践任务_按开课单位_20171101
				 */
				$('#exportExcel').click(function() {
					...
					if (utils.isNotEmpty(exportNum) && parseInt(exportNum) > 20000) {
						...
						ajaxData.exportFile(URL_COURSEPLAN.ARRANGE_COURSE_EXPORTKPRACTICALSTATISTIC, searchCourseUnitsList.pagination.option.param);
					}
				}); 
	...
	module.exports = searchCourseUnitsList; //根文件夹名称一致
	window.searchCourseUnitsList = searchCourseUnitsList;    //根据文件夹名称一致
});