...
define(function(require, exports, module) {
	...
	var importFilePhono = {
		init : function(option){
			...
			var uploader = new uploaderFile({
		        ...
		        callBack: function (data) {
		        	...
		        	if(data.code == config.RSP_SUCCESS){
		        		if(data.data != null){
			        		...
			        		var nameWay = $("input[name='photoName']:checked").val();
			        		var isAppend = $("input[name='isValidity']:checked").val();
			        		
			    			var reqData ={photoList:models,nameWay:nameWay,isAppend:isAppend};
			    			ajaxData.setContentType("application/json;charset=UTF-8");
			    			ajaxData.request(me.option.templateUrl,JSON.stringify(reqData),function(data){
			    				if(data.code == config.RSP_SUCCESS){
			    					importFilePhono.loadBack(data.data);
		        ...
		        auto:false,
		        module:me.option.module,
		        fileSize:me.option.fileSize,
	...
	module.exports = importFilePhono;
});
