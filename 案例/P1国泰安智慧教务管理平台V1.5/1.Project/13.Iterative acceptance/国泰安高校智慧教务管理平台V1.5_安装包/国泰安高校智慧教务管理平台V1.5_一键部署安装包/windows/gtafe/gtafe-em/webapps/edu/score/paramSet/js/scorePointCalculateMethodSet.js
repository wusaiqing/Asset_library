...
define(function(require, exports, module) {
	...
	var course = {
		 ...
		 */
		addCourse: function(){			
			var myDialog= art.dialog.open(base+'/trainplan/courseResource/course/html/add.html', // 这里是页面的路径地址
				{
					id : 'addCourse',// 唯一标识
					title : '课程信息新增',// 这是标题
		...
		editCourse: function(obj){	
			var courseId = $(obj).attr("data-tt-id");// 获取this对象的属性
			var myDialog= art.dialog.open(base+'/trainplan/courseResource/course/html/add.html?courseId=' + courseId,
				{
					id : 'editCourse',// 唯一标识
					title : '课程信息修改',// 这是标题
					width : 900,// 这是弹窗宽度。其实可以不写
